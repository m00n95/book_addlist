...
var Livre = /*#__PURE__*/function () {
  function Livre(title, author, image) {
  ...
  _createClass(Livre, [{
    key: "createLivreElement",
    value: function createLivreElement() {
      var livreElement = document.createElement('div');
...
var _livre = _interopRequireDefault(require("./livre"));
...
form.addEventListener('submit', function (e) {
  ...
  var newLivre = new _livre.default(title, author, image);
  var livreElement = newLivre.createLivreElement();
  $(livreElement).hide(); // cacher l'élément avant le fade in

  var deleteButton = livreElement.querySelector(".delete"); // Pour effacer une carte grâce au bouton supprimer
  deleteButton.addEventListener("click", function () {
    livreElement.remove();
  });
  var livresContainer = document.querySelector('.row');
...
},{"./livre":"src/livre.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
